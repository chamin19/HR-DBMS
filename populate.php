...
<?php
    ...
    $sql = "INSERT INTO bank_account VALUES 
            ...
            (123,98099,003,1578475),
            (126,08980,003,0897654),
            (130,12031,003,0918273),
            (209,23456,003,9938475),
            (139,08980,003,0908076),
            (149,23456,003,1829374),
            (156,08980,003,9384710),
            (158,08960,003,9389710),
            (309,67456,003,5558475),
